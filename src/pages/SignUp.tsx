...
const SignUp = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <div className="shrink-0 gradient-btn px-4 py-2 sm:py-2.5 text-center text-xs sm:text-sm">
      ...
      <div className="flex flex-1 items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="mb-6 sm:mb-8 text-center">
            <h1 className="text-3xl sm:text-4xl font-bold gradient-text">ODHex</h1>
            <p className="mt-1.5 text-sm text-muted-foreground">Create your Vault</p>
          </div>

          <div className="glass-card p-5 sm:p-8">
            <h2 className="mb-5 sm:mb-6 text-xl font-semibold text-foreground">Sign Up</h2>
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="mt-1 text-xs text-muted-foreground/70">Required for bank verification</p>
              </div>
              <div>
